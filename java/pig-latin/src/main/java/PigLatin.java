...
public class PigLatin {
  ...
  private static final Set<Character> VOWELS_SET = new HashSet<Character>(Arrays.asList(VOWELS));
  ...
  private static boolean tripleConsonant(String word) {
    return (word.startsWith("squ") || word.startsWith("sch") || word.startsWith("thr"));
  }
