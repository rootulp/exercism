...
class BinarySearchTreeTest(unittest.TestCase):
    ...
    def test_can_create_complex_tree(self):
        ...
        self.assertTreeEqual(
            BinarySearchTree(['4', '2', '6', '1', '3', '5', '7']).node_data(),
            expected
        )
